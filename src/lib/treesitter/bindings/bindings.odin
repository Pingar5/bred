...
when ODIN_OS == .Windows {
    foreign import ts "lib/libtree-sitter.lib"
} else {
    foreign import ts "lib/libtree-sitter.a"
}
...
//     _highlighter_add_language :: proc(self: ^Highlighter, language_name: cstring, scope_name: cstring, injection_regex: cstring, language: Language, highlight_query: cstring, injection_query: cstring, locals_query: cstring, highlights_query_len: u32, injection_query_len: u32, locals_query_len: u32, apply_all_captures: bool) -> Highlight_Error ---
...
//     _highlighter_highlight :: proc(self: ^Highlighter, scope_name: cstring, source_code: cstring, source_code_len: u32, output: ^Highlight_Buffer, cancellation_flag: ^uint) -> Highlight_Error ---
