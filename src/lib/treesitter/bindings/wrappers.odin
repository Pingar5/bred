...
// highlighter_new :: #force_inline proc(
//     highlight_names: []cstring,
//     attribute_strings: []cstring,
// ) -> ^Highlighter {
//     assert(
//         len(highlight_names) == len(attribute_strings),
//         "highlight_names must be the same length as attribute_strings",
//     )
//     return _highlighter_new(
//         raw_data(highlight_names),
//         raw_data(attribute_strings),
//         u32(len(highlight_names)),
//     )
// }
